...
enum OBJID { OBJ_FEATURE, OBJ_PLAYER, OBJ_BULLET, OBJ_MONSTER, OBJ_GUN, OBJ_MONSTER_BULLET, OBJ_MOUSE, OBJ_SHIELD, OBJ_BUTTON, OBJ_END };
...
enum class GUN_TYPE { PISTOL, SMG, AK47, SHOTGUN, RAILGUN, NONE };
