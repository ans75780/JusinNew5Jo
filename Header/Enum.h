...
enum OBJID { OBJ_FEATURE, OBJ_ITEM, OBJ_PLAYER, OBJ_BULLET, OBJ_MONSTER, OBJ_BOSS, OBJ_BOSS_BULLET, OBJ_GUN, OBJ_MONSTER_BULLET, OBJ_MOUSE, OBJ_SHIELD, OBJ_BUTTON, OBJ_END };
